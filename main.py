...
api_url = "https://ugxclassplusapi.vercel.app/cpsign?url={url}&token={eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..SlbU12uwJ3zr3qrgPpClE0OG3snIGOUH8Erm5sd0ZYcj1joctVa8marAQtP2CLHf}"
api_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNzkxOTMzNDE5NSIsInRnX3VzZXJuYW1lIjoi4p61IFtvZmZsaW5lXSIsImlhdCI6MTczODY5MjA3N30.SXzZ1MZcvMp5sGESj0hBKSghhxJ3k1GTWoBUbivUe1I"
token_cp = 'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..4zc-Hk7hZM6MWv11h5Ne6ceoPjTqxCwj1YlfXg_qDn6vNuDgnFfkQBQm10QBkPpY'
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Bhairakaka_contact_Bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="http://t.me/Bhairakaka_contact_Bot"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+nRf2boIxwvgzYzk1"),
        ],
    ]
)
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"╭────────⊰◆⊱────────╮\n"   
        f" ➠ 𝐌𝐚𝐝𝐞 𝐁𝐲 : [𝐊𝐀𝐊𝐀 𝘽𝙊𝙏𝙎](http://t.me/Bhairakaka_contact_Bot) 💻\n"
        f"╰────────⊰◆⊱────────╯\n"
        )
    )                    
...
async def txt_handler(bot: Client, m: Message):  
    ...
    if raw_text3 == '1':
        CR = '[𝄟⃝‌🐬𝐀𝐖𝐀𝐀𝐙𝄟⃝🐬](https://t.me/+nRf2boIxwvgzYzk1)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [😍𝙆𝘼𝙆𝘼 𝘽𝙊𝙏𝙎🐦](https://t.me/+nRf2boIxwvgzYzk1)"
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           f"🛑**Send** /stop **to stop process**\n┃\n" \
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [𝐊𝐀𝐊𝐀 𝐁𝐎𝐓𝐒🐦](https://t.me/+nRf2boIxwvgzYzk1)"
                    prog = await m.reply_text(Show, disable_web_page_preview=True)
